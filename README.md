...
- [JMP.chat](https://jmp.chat) — your phone number on every device exclusively
  using free software
- [Cheogram.com](https://cheogram.com) — set of extensible services aiming to
  connect open communication networks: telephone, email, SIP, Jabber, and
  others
- [Soprani.ca](https://soprani.ca) — umbrella project for the software powering
  JMP and Cheogram
- [Adresilo.com](https://adresilo.com) — search Google Maps without giving
...
[^2]: except [Willow](https://github.com/Amolith/willow), to maybe get more
      contributors once I start working on it in earnest again
